...
Sessiz Oda, en fazla üç kişinin aynı anda kullanması için hazırlanmış küçük bir Android sohbet uygulamasıdır. Mesaj geçmişi, hesap, veritabanı, analitik veya uygulama içi log yoktur. Sunucu yalnızca o anda bağlı cihazlar arasında şifreli paketleri iletir.
...
- Oda başına varsayılan en fazla üç bağlantı ve basit hız sınırı
...
| `MAX_ROOM_SIZE` | `3` | Aynı odadaki en fazla bağlantı |
